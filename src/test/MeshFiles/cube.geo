...
Line(5) = {4, 5};      
Transfinite Line {5} = 3 Using Progression 1;
Line(6) = {1, 6};      
Transfinite Line {6} = 3 Using Progression 1;
Line(7) = {5, 6};      
Transfinite Line {7} = 3 Using Progression 1;
Line(8) = {2, 7};      
Transfinite Line {8} = 3 Using Progression 1;
Line(9) = {6, 7};      
Transfinite Line {9} = 3 Using Progression 1;
Line(10) = {3, 8};
Transfinite Line {10} = 3 Using Progression 1;
Line(11) = {7, 8};      
Transfinite Line {11} = 3 Using Progression 1;
Line(12) = {8, 5};      
Transfinite Line {12} = 3 Using Progression 1;
Line Loop(1) = {4, 1, 2, 3};
Plane Surface(1) = {1};
Line Loop(2) = {5, 7, -6, -4};
Plane Surface(2) = {2};
